...
fps = 40  # Broj frejmova po sekundi
...
class Game():
    def __init__(self, line_thickness=10, speed=5):
        ...
        # Inicijalizuje varijable i stavlja ih u pocetni polozaj
...
class Ball(pygame.sprite.Sprite):
    ...
    # Pomeranje loptice na novu poziciju
    def move(self):
